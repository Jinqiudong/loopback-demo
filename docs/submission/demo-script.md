...
3-minute demo video. Two Slack accounts: Jinqiu plays the BA (requester), Jie plays the DE (resolver).
...
4. Jinqiu replies: **"yes"**
5. Card transitions to **human_working** — findings visible in card, Jie looped in
6. Jie (as DE): replies directly to Jinqiu in thread:
...
4. Card shows: ⚡ *Answered from Knowledge Vault* — confidence score, original owner (@Jie), verified date
